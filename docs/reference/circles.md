...
![Circle generation with Charles deployments](../.gitbook/assets/deploy_em_circulos%20%289%29%20%281%29%20%281%29.png)
...
![ How to create a circle](../.gitbook/assets/create-circle-newww%20%282%29.gif)
...
![](../.gitbook/assets/circuloid%20%281%29%20%281%29.gif)
...
This way allows you to extract from an external client’s IDs base, a specific profile and import it directly on Charles.
...
Once the **circle which the user belongs to** is detected, this information must be passed on to all next requests through the `x-circle-id` parameter in the header. Charles detects by the circle’s ID which application version a given request must be forwarded to. Let's see how it works in the example below:

![](../.gitbook/assets/como_integrar_circulos_com_servicos_copy%20%282%29%20%281%29.png)
...
![](../.gitbook/assets/versoes_diferentes_na_minha_release_eng%20%281%29%20%281%29.png)
...
![Example of Application 1 and Application 2](../.gitbook/assets/versoes_diferentes_na_minha_release_ii_eng%20%281%29%20%281%29.png)
